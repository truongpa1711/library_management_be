...
public class AuthService {
    ...
    public BaseRespone<String> register(RegisterRequest registerRequest) {
    ...
    public BaseRespone<String> verifyEmail(String token) {
    ...
    public BaseRespone<String> resendVerificationEmail(ResendVerificationRequest resendVerificationRequest) {
    ...
    public BaseRespone<RefreshTokenResponse> refreshToken(RefreshTokenRequest refreshTokenRequest) {
        ...
        return BaseRespone.<RefreshTokenResponse>builder()
                .status("success")
                .message("Tokens refreshed successfully")
                .data(new RefreshTokenResponse(newAccessToken, newRefreshToken))
                .build();
    }
    public BaseRespone<String> forgotPassword(ForgotPasswordRequest forgotPasswordRequest) {
